...
<body>
	...
	<ssauth:ifLoggedIn>
		You are currently logged in as: <ssauth:user/>
		<h2>Log out</h2>
		<ssauth:form authAction="logout" success="[controller:'authentication', action:'index']" error="[controller:'authentication', action:'index']">
		    <g:actionSubmit value="Log out"/> 
		</ssauth:form>
	</ssauth:ifLoggedIn>
	<ssauth:ifUnconfirmed>
	...
	<p>You are not logged in. Please log in or sign up:</p>
		<h2>Log in</h2>
		<ssauth:form authAction="login" success="[controller:'authentication', action:'index']" error="[controller:'authentication', action:'index']">
